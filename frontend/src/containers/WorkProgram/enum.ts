export enum fields {
    ...
    AP_WITH_COMPETENCES_AND_INDICATORS_TO_WP = 'AP_WITH_COMPETENCES_AND_INDICATORS_TO_WP',
    ALL_COMPETENCES_AND_INDICATORS_FOR_WP = 'ALL_COMPETENCES_AND_INDICATORS_FOR_WP',
...
export enum fetchingTypes {
    ...
    SAVE_ZUN_FOR_THIS_EP = 'SAVE_ZUN_FOR_THIS_EP',
    ...
    GET_AP_WITH_COMPETENCES_AND_INDICATORS_TO_WP = 'GET_AP_WITH_COMPETENCES_AND_INDICATORS_TO_WP',
    GET_ALL_COMPETENCES_AND_INDICATORS_FOR_WP = 'GET_ALL_COMPETENCES_AND_INDICATORS_FOR_WP',
